          ...
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
              <a class="sidebar-link sidebar-title" href="/dashboard">
                ...
                <svg class="fill-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#fill-home"></use>
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="#">
                <svg class="stroke-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#stroke-landing-page"></use>
                </svg>
                <svg class="fill-icon">
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="#">
                <svg class="stroke-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#stroke-reports"></use>
                </svg>
                <svg class="fill-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#fill-reports"></use>
                </svg><span>Resume</span></a>
              <ul class="sidebar-submenu">
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="#">
                <svg class="stroke-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#stroke-job-search"></use>
                </svg>
                <svg class="fill-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#fill-job-search"></use>
                </svg><span>Works</span></a>
              <ul class="sidebar-submenu">
                <li><a href="general-widget.html">General</a></li>
                <li><a href="chart-widget.html">Chart</a></li>
              </ul>
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="#">
                <svg class="stroke-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#stroke-blog"></use>
                </svg>
                <svg class="fill-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#fill-blog"></use>
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="#">
                <svg class="stroke-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#stroke-email-temp"></use>
                </svg>
                <svg class="fill-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#fill-email-temp"></use>
            ...
            <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="#">
                <svg class="stroke-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#stroke-widget"></use>
                </svg>
                <svg class="fill-icon">
                  <use href="assets/admin/svg/icon-sprite.svg#fill-widget"></use>
