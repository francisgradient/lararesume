...
<div class="page-header">
    <div class="header-wrapper row m-0">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="assets/admin/images/logo/logo.png" alt=""><img class="img-fluid for-dark" src="assets/admin/images/logo/logo_dark.png" alt=""></a></div>
        <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
      </div>
      <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
        {{-- Header slider located in header-slick-js --}}
        <div class="notification-slider">
          <div class="d-flex h-100"> <i class="fa-solid fa-bolt txt-warning p-r-10"></i>
        ...
        <ul class="nav-menus">
          ...
          <li class="fullscreen-body">                       <span>
              <svg id="maximize-screen">
                <use href="assets/admin/svg/icon-sprite.svg#full-screen"></use>
              </svg></span></li>
          <li>                         <span class="header-search">
              <svg>
                <use href="assets/admin/svg/icon-sprite.svg#search"></use>
              </svg></span></li>
          ...
          <li class="cart-nav onhover-dropdown">
            <div class="cart-box">
              <svg>
                <use href="assets/admin/svg/icon-sprite.svg#stroke-ecommerce"></use>
            ...
            <div class="cart-dropdown onhover-show-div">
              ...
              <ul>
                <li>
                  <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="assets/admin/images/other-images/cart-img.jpg" alt="">
                ...
                <li>
                  <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="assets/admin/images/other-images/cart-img1.jpg" alt="">
          ...
          <li class="onhover-dropdown">
            <div class="notification-box">
              <svg>
                <use href="assets/admin/svg/icon-sprite.svg#notification"></use>
          ...
          <li class="profile-nav onhover-dropdown pe-0 py-0">
            <div class="d-flex profile-media"><img class="b-r-10" src="assets/admin/images/dashboard/profile.png" alt="">
