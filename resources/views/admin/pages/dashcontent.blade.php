...
<div class="page-body">
    ...
    <div class="row widget-grid">
        ...
        <div class="card profile-box">
            ...
            <div class="d-flex media-wrapper justify-content-between">
                ...
                <div class="greeting-user">
                    <h2 class="f-w-600">Welcome {{$name}}!</h2>
            ...
            <div class="cartoon"><img class="img-fluid" src="assets/admin/images/dashboard/cartoon.svg" alt="vector women with leptop"></div>
            </div>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="card widget-1">
                ...
                <div class="widget-content">
                    ...
                    <div class="bg-round">
                        <svg>
                        <use href="assets/admin/svg/icon-sprite.svg#c-revenue"> </use>
                        </svg>
        ...
        <div class="row">
            ...
            <div class="card widget-1">
                ...
                <div class="widget-content">
                    ...
                    <div class="bg-round">
                        <svg>
                        <use href="assets/admin/svg/icon-sprite.svg#c-profit"> </use>
                        </svg>
                        <svg class="half-circle svg-fill">
                        <use href="assets/admin/svg/icon-sprite.svg#halfcircle"></use>
                        </svg>
                ...
                <div class="card-body">
                    ...
                    <div class="widget-round primary">
                        ...
                        <svg class="fill-primary">
                            <use href="assets/admin/svg/icon-sprite.svg#c-invoice"> </use>
                        </svg>
                        <svg class="half-circle svg-fill">
                            <use href="assets/admin/svg/icon-sprite.svg#halfcircle"></use>
                        </svg>
        ...
        <div class="card">
            ...
            <div class="recent-table table-responsive custom-scrollbar">
                ...
                <tbody>
                    ...
                    <td> </td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard/user/2.jpg" alt="user">
                    ...
                    <td></td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard/user/3.jpg" alt="user">
                    ...
                    <td> </td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard/user/4.jpg" alt="user">
                    ...
                    <td> </td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard/user/5.jpg" alt="user">
                    ...
                    <td> </td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard-9/user/1.png" alt="user">
                    ...
                    <td> </td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard-9/user/2.png" alt="user">
                    ...
                    <td> </td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard-9/user/5.png" alt="user">
                    ...
                    <td> </td>
                    <td>
                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2" src="assets/admin/images/dashboard-9/user/3.png" alt="user">
        ...
        <div class="card activity-log notification main-timeline">
            ...
            <ul>
                ...
                <div class="w-100 ms-3">
                    ...
                    <li><img class="img-fluid" src="assets/admin/images/dashboard/bg-1.png" alt="background"></li>
                    <li><img class="img-fluid" src="assets/admin/images/dashboard/bg-2.png" alt="background"></li>
                    <li><img class="img-fluid" src="assets/admin/images/dashboard/bg-3.png" alt="background"></li>
                    </ul>
            ...
            <div class="recent-table table-responsive currency-table recent-order-table custom-scrollbar">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/16.png" alt=""></div>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/25.png" alt=""></div>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/26.png" alt=""></div>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/24.png" alt=""></div>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/6.png" alt=""></div>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/10.png" alt=""></div>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/11.png" alt=""></div>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                        <div class="currency-icon warning"><img class="img-fluid" src="assets/admin/images/dashboard-2/order/sub-product/14.png" alt=""></div>
        ...
        <div class="card buy-card"><img class="img-fluid" src="assets/admin/images/dashboard/purchase1.png" alt="vector mens with laptop">
            <div class="card-body">
